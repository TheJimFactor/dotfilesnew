...
" terrible broken code goes here BUGGYBPCODE
"let python_highlight_builtins = 1
"let python_highlight_exceptions = 1
" Keywords
syn keyword pythonStatement	break continue del bpfucker
...
syn keyword pythonRepeat	for while bpfucker2
...
if exists("python_highlight_builtin_funcs") && python_highlight_builtin_funcs != 0
  " Builtin functions
  syn keyword pythonBuiltinFunc	__import__ abs all any ascii bpfucker3
